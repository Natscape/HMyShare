...
<div class="selfindex">
	...
	<div class="two_index">
		<div class="two_index_1">
			<a href="<%=path %>/page/myphoto.jsp" style="background-color:#DAA520;opacity:0.9;">
			<img src="<%=path %>/image/image/picture1.png">
			<div class="two_index_1_1">相册</div>
			</a>
			<a href="<%=path %>/page/myfocus.jsp" style="background-color:#B23AEE;opacity:0.9;">
				<img src="<%=path %>/image/image/focus1.png">
			<div class="two_index_1_1">关注</div>
			</a>
		</div>
		<div class="two_index_1">
			<a href="<%=path %>/page/showimage.jsp" style="background-color:#003366;opacity:0.9;">
				<img src="<%=path %>/image/image/self1.png">
			    <div class="two_index_1_1">发图</div>
			</a>
			<a href="<%=path %>/page/mycollection.jsp" style="background-color:#006400;opacity:0.9;">
...
<div class="imgshow_top">
		...
		<div class="imgshow_top3"><a href="<%=path %>/page/myphoto.jsp?id=?"><img src="<%=path %>/image/image/user.png"></a></div>
	</div>
<div class="imgshow">
